...
""" % bcb_dev)
  ...
  date = target_info.GetBuildProp("ro.milk.build.date")
  version = target_info.GetBuildProp("ro.milk.version")

  if target_info.GetBuildProp("ro.product.model") is not None:
    model = target_info.GetBuildProp("ro.product.model")
    script.Print("***********************************************");
    script.Print("           PROJECTMILK for %s"%(model));
    script.Print("               BY: Febri Cahyaa                ");
    ...
    script.Print("***********************************************");
    script.Print("           PROJECTMILK for %s"%(name));
    script.Print("               BY: Febri Cahyaa                ");
    script.Print("   VERSION: %s"%(version));
    script.Print("   COMPILED ON: %s"%(date));
    script.Print("***********************************************");
